...
class BookFormFiller
{
    ...
    public static function fillBasicInfo($bookId)
    {
        if ($bookId == null) {
            ...
            $bookRepository = App::make('BookRepository');

            $book = $bookRepository->find($bookId, array('tags'));
    ...
    public static function fillForBookExtras($bookId)
    {
        ...
        $book = $bookRepository->find($bookId, array('publisher_serie', 'serie'));
    ...
    public static function fillForAuthor($id)
    {
        ...
        $book = $bookRepository->find($id, array('authors'));
    ...
    public static function fillForPersonalInfo($id)
    {
        ...
        $book = $bookRepository->find($id, array('personal_book_info'));
    ...
    public static function fillForFirstPrint($bookId)
    {
        ...
        $book = $bookRepository->find($bookId, array('first_print_info'));
    ...
    public static function fillForBuyInfo($bookId)
    {
        ...
        $book = $bookRepository->find($bookId, array('personal_book_info'));
