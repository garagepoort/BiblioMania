...
@section('content')
    ...
    <div class="statistics-container">
        ...
        <div class="card-row">
            ...
            <div id="booksReadPerYearContainer" class="chartContainer-genre material-card card-column-right" style="width: 32%">
        ...
        <script type="text/javascript">
            ...
            function drawGenreChart() {
                drawDonutChartFromUrl('chart_div_books_per_genre', baseUrl + "/getBooksPerGenreChart", 310, 310);
            }
            function drawBooksAddedPerYearChart() {
                drawDonutChartFromUrl('chart_div_books_added_per_year', baseUrl + "/getBooksAddedPerYearChart", 310, 310);
            }
            function drawBooksReadPerYearChart() {
                drawDonutChartFromUrl('chart_div_books_read_per_year', baseUrl + "/getBooksReadPerYearChart", 310, 310);
            }
        </script>
