...
<legend>Koop info</legend>
    ...
    <div class="form-container">
            ...
            <div class="form-group">
                <!-- BUY DATE -->
                {{ Form::label('buyInfoBuyDate', 'Aankoopdatum:', array('class' => 'col-md-3 control-label')); }}
                <div class="col-md-3">
            ...
            <div class="form-group">
                <!-- CURRENCY -->
                {{ Form::label('buy_info_price_payed_label', 'Aankoop prijs:', array('class' => 'col-md-3 control-label')); }}
                <div class="col-md-2">
            ...
            <!-- REASON -->
            <div class="form-group">
                {{ Form::label('buy_info_reason_label', 'Reden:', array('class' => 'col-md-3 control-label')); }}
                <div class="col-md-5">
              ...
              <!-- SHOP -->
            <div class="form-group">
                {{ Form::label('buy_info_shop_label', 'Winkel:', array('class' => 'col-md-3 control-label')); }}
                <div class="col-md-5">
            ...
            <!-- SHOP CITY-->
            <div class="form-group">
                {{ Form::label('buy_info_shop_label', 'Stad winkel:', array('class' => 'col-md-3 control-label')); }}
                <div class="col-md-5">
             ...
             <!-- COUNTRY -->
            <div class="form-group">
                 {{ Form::label('buy_info_country_label', 'Land:', array('class' => 'col-md-3 control-label')); }}
                    <div class="col-md-5">
