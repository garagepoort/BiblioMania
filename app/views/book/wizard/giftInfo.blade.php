<fieldset>
    ...
    <div class="form-container">
        <div class="form-group">
            <!-- RECEIPT DATE -->
            {{ Form::label('giftInfoReceiptDate', 'Ontvangstdatum:', array('class' => 'col-md-3 control-label')); }}
            <div class="col-md-3">
        ...
        <!-- FROM -->
        <div class="form-group">
            {{ Form::label('buy_info_from_label', 'Gekregen van:', array('class' => 'col-md-3 control-label')); }}
            <div class="col-md-5">
        ...
        <!-- OCCASION -->
        <div class="form-group">
            {{ Form::label('gift_info_occasion_label', 'Gelegenheid:', array('class' => 'col-md-3 control-label')); }}
            <div class="col-md-5">
        ...
        <!-- REASON -->
        <div class="form-group">
            {{ Form::label('gift_info_reason_label', 'Reden:', array('class' => 'col-md-3 control-label')); }}
            <div class="col-md-5">
