...
controller:"ReadingDateModalController",resolve:{personalBookInfo:{personalBookInfoId:b},readingDateModel:d}});e.result.then(c)}};return b}this.$get=["$uibModal",function(b){return new a(b)}]}).controller("ReadingDateModalController",["$scope","ErrorContainer","personalBookInfo","readingDateModel",function(a,b,c,d){function e(){a.data={},a.data.readingDateModel=d,a.data.personalBookInfoId=c.personalBookInfoId,a.data.onSaveReadingDate=function(b){a.$close(b)}}e()}]),angular.module("com.bendani.bibliomania.reading.date.model",["ngResource"]).factory("ReadingDate",["$resource",function(a){return a("../BiblioMania/reading-dates/:id",{},{update:{method:"PUT",url:"../BiblioMania/reading-dates"}})}]),angular.module("com.bendani.bibliomania.shop.model",["ngResource"]).factory("Shop",["$resource",function(a){return a("../BiblioMania/shops",{})}]),angular.module("com.bendani.bibliomania.publisher.model",["ngResource"]).factory("Publisher",["$resource",function(a){return a("../BiblioMania/publishers",{})}]),angular.module("com.bendani.bibliomania.publisher.overview.ui",["com.bendani.bibliomania.publisher.model","com.bendani.bibliomania.title.panel"]).config(["$routeProvider",function(a){a.when("/publishers",{templateUrl:"../BiblioMania/views/partials/publisher/publishers-overview.html",controller:"PublishersOverviewController"})}]).controller("PublishersOverviewController",["$scope","Publisher","ErrorContainer","TitlePanelService","$location",function(a,b,c,d,e){function f(){d.setTitle("Uitgevers"),d.setShowPreviousButton(!1),a.searchSeriesQuery="",a.predicate="name",a.reverseOrder=!1,a.orderValues=[{key:"Naam",predicate:"name",width:"50"}],g()}function g(){a.loading=!0,a.publishers=b.query(function(){a.loading=!1},c.handleRestError)}a.search=function(b){return-1!==b.name.toLowerCase().indexOf(a.searchSeriesQuery)?!0:!1},a.goToPublisherDetails=function(a){e.path("/edit-publisher/"+a.id)},a.setListView=function(b){a.listView=b},f()}]),angular.module("com.bendani.bibliomania.publisher.serie.model",["ngResource"]).factory("PublisherSerie",["$resource",function(a){return a("../BiblioMania/publisher-series",{},{update:{method:"PUT"},addBook:{method:"POST",url:"../BiblioMania/publisher-series/:id/books"},removeBook:{method:"PUT",url:"../BiblioMania/publisher-series/:id/remove-book"}})}]),angular.module("com.bendani.bibliomania.serie.model",["ngResource"]).factory("Serie",["$resource",function(a){return a("../BiblioMania/series",{},{update:{method:"PUT"},addBook:{method:"POST",url:"../BiblioMania/series/:id/books"},removeBook:{method:"PUT",url:"../BiblioMania/series/:id/remove-book"}})}]),angular.module("com.bendani.bibliomania.series.overview.ui",["com.bendani.bibliomania.serie.model","com.bendani.bibliomania.publisher.serie.model","com.bendani.bibliomania.book.model","com.bendani.bibliomania.book.overview.service","com.bendani.bibliomania.edit.serie.modal.service","com.bendani.bibliomania.title.panel"]).config(["$routeProvider",function(a){a.when("/series",{templateUrl:"../BiblioMania/views/partials/book/series-overview.html",controller:"SeriesOverviewController",resolve:{title:function(){return"Boeken reeksen"},client:["Serie",function(a){return a}]}}),a.when("/publisherseries",{templateUrl:"../BiblioMania/views/partials/book/series-overview.html",controller:"SeriesOverviewController",resolve:{title:function(){return"Uitgever reeksen"},client:["PublisherSerie",function(a){return a}]}})}]).controller("SeriesOverviewController",["$scope","ErrorContainer","TitlePanelService","BookOverviewService","Book","$location","EditSerieModalService","title","client",function(a,b,c,d,e,f,g,h,i){function j(){c.setTitle(h),c.setShowPreviousButton(!1),a.searchSeriesQuery="",a.predicate="name",a.reverseOrder=!1,a.orderValues=[{key:"Naam",predicate:"name",width:"50"}],k(),d.registerHandler(l),a.$on("$destroy",function(){d.deregisterHandler(l)})}function k(){a.loading=!0,a.series=i.query(function(){a.loading=!1},b.handleRestError)}var l=function(c){a.bookDetailPanelOpen&&a.selectedBook.id===c.id?a.bookDetailPanelOpen=!1:(a.selectedBook=e.get({id:c.id},function(){},b.handleRestError),a.bookDetailPanelOpen=!0)};a.search=function(b){return-1!==b.name.toLowerCase().indexOf(a.searchSeriesQuery)?!0:!1},a.onImageClickBook=function(a){d.selectBook(a)},a.editSerie=function(a){g.show(a,i,function(){})},a.onEditBook=function(a){f.path("/book-details/"+a.id)},a.setListView=function(b){a.listView=b},j()}]),angular.module("com.bendani.bibliomania.tag.model",["ngResource"]).factory("Tag",["$resource",function(a){return a("../BiblioMania/tags",{})}]),angular.module("com.bendani.bibliomania.user.model",["ngResource"]).factory("User",["$resource",function(a){return a("../BiblioMania/users/:id",{},{loggedInUser:{method:"GET",url:"../BiblioMania/loggedInUser"}})}]),angular.module("com.bendani.bibliomania.wishlist.model",["ngResource"]).factory("Wishlist",["$resource",function(a){return a("../BiblioMania/users/:id/wishlist",{},{get:{method:"GET",url:"../BiblioMania/users/:id/wishlist",isArray:!0},addBook:{method:"POST",url:"../BiblioMania/users/:id/wishlist"},removeBook:{method:"PUT",url:"../BiblioMania/users/:id/wishlist/remove-book"}})}]),BookCard.prototype.create=function(){var a=getImageStyle(this.bookImageObject.height,this.bookImageObject.width,this.bookImageObject.imageString,this.bookImageObject.spritePointer),b=$("<div></div>");b.attr("class","material-card imageLinkWrapper ic_container"),b.attr("style","width: "+this.bookImageObject.width+"px;");var c=$("<div></div>");c.attr("class","material-card-content"),c.attr("style",a),addReadIcon.call(this,c);var d=30;for(var e in this.warnings){var f=this.warnings[e],g=getIcon(f.icon,f.message,"warning-icon");g.attr("style","top: "+d+"px"),c.append(g),d+=25,f.goToLink&&""!==f.goToLink&&(g.addClass("clickableImage"),g.attr("href",baseUrl+f.goToLink+this.id))}return b.append(c),$(".clickableImage").click(function(){window.document.location=$(this).attr("href")}),b.attr("bookid",this.id),b},function(a){a.fn.capslide=function(b){var c=a.extend({},a.fn.capslide.defaults,b);return this.each(function(){$this=a(this);var b=a.meta?a.extend({},c,$this.data()):c;b.showcaption?$this.find(".ic_text").css("display","none"):$this.find(".ic_caption").css("display","none");var d=$this.first(),e=d.css("width"),f=d.css("height");a(".ic_caption",$this).css({color:b.caption_color,"background-color":b.caption_bgcolor,bottom:"0px",width:e}),a(".overlay",$this).css("background-color",b.overlay_bgcolor),$this.css({width:e,height:f,border:b.border}),$this.hover(function(){navigator.appVersion.indexOf("MSIE 7.0")>0?a(".overlay",a(this)).show():a(".overlay",a(this)).fadeIn(),b.showcaption?a(".ic_text",a(this)).slideDown(200):a(this).find(".ic_caption").slideDown(200)},function(){navigator.appVersion.indexOf("MSIE 7.0")>0?a(".overlay",a(this)).hide():a(".overlay",a(this)).fadeOut(),b.showcaption?a(".ic_text",a(this)).slideUp(200):a(this).find(".ic_caption").slideUp(200)})})},a.fn.capslide.defaults={caption_color:"white",caption_bgcolor:"black",overlay_bgcolor:"blue",border:"1px solid #fff",showcaption:!0}}(jQuery);
>>>>>>> e22560d2f9bfc9f81ecdf0670302e05eef2597bd
