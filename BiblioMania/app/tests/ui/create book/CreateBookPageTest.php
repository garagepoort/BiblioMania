...
{ 
    ...
    public function testFillInAuthorOnBookInfo_copiesValueToAuthor(){
        ...
        $this->findElementById('book_author_input')->sendKeys('author, mid, authorson');
        ...
        //name without infix
        $this->findElementById('book-info-tab-link')->click();
        $this->findElementById('book_author_input')->clear();
        $this->findElementById('book_author_input')->sendKeys('author, authorson');
        $this->findElementById('author-info-tab-link')->click();
        $this->assertEquals($this->findElementById('author_name')->getAttribute('value'), 'author');
        $this->assertEquals($this->findElementById('author_firstname')->getAttribute('value'), 'authorson');
        ...
        $this->findElementById('book-info-tab-link')->click();
        $this->findElementById('book_author_input')->clear();
        $this->findElementById('book_author_input')->sendKeys('author some, mid, authrosons 2nd');
        $this->findElementById('author-info-tab-link')->click();
...
//    }
    ...
    private function goToCreateBookPage(){
